...
| 声明 | 主要来源 | QuViz 验证 | 边界 |
|---|---|---|---|
| $Y_\ell^m$ 与 Laguerre 定义/约定 | [@dlmf-spherical-harmonics; @dlmf-laguerre; @griffiths2018qm] | 归一化、正交、节点和已知式 | SciPy 参数顺序必须显式映射 |
...
| 声明 | 主要来源 | QuViz 验证 | 边界 |
|---|---|---|---|
| 单轨道分离采样的概率测度 | [@griffiths2018qm; @numpy-rng] | 径向/角向边际、矩与 seed 重现 | 必须报告有限径向域捕获质量 |
